...
//----------------------------------------------------------------------
//------------------------------------------------------------------------------
// Title -- XVM TLM Channel Classes
//------------------------------------------------------------------------------
// This section defines built-in XVM TLM channel classes.
//------------------------------------------------------------------------------

//------------------------------------------------------------------------------
//
// CLASS -- xvm_tlm_req_rsp_channel #(REQ,RSP)
//
// The xvm_tlm_req_rsp_channel contains a request FIFO of type ~REQ~ and a response
...
class xvm_tlm_req_rsp_channel #(type REQ=int, type RSP=REQ) extends uvm_component;

  typedef xvm_tlm_req_rsp_channel #(REQ, RSP) this_type;

  `uvm_component_param_utils(xvm_tlm_req_rsp_channel#(REQ,RSP))
  `uvm_type_name_decl("xvm_tlm_req_rsp_channel #(REQ,RSP)")
  ...
  xvm_put_export #(REQ) put_request_export;
  ...
  xvm_get_peek_export #(RSP) get_peek_response_export;
  ...
  xvm_get_peek_export #(REQ) get_peek_request_export;
  ...
  xvm_put_export #(RSP) put_response_export;
  ...
  xvm_analysis_port #(REQ) request_ap;
  ...
  xvm_analysis_port   #(RSP) response_ap;
  ...
  xvm_master_imp #(REQ, RSP, this_type, xvm_tlm_fifo #(REQ), xvm_tlm_fifo #(RSP)) master_export;
  ...
  xvm_slave_imp  #(REQ, RSP, this_type, xvm_tlm_fifo #(REQ), xvm_tlm_fifo #(RSP)) slave_export;

  // port aliases for backward compatibility
  xvm_put_export      #(REQ) blocking_put_request_export,
                             nonblocking_put_request_export;
  xvm_get_peek_export #(REQ) get_request_export,
  ...
  xvm_put_export      #(RSP) blocking_put_response_export,
                             nonblocking_put_response_export;
  xvm_get_peek_export #(RSP) get_response_export,
  ...
  xvm_master_imp #(REQ, RSP, this_type, xvm_tlm_fifo #(REQ), xvm_tlm_fifo #(RSP))
                             blocking_master_export, 
                             nonblocking_master_export;

  xvm_slave_imp  #(REQ, RSP, this_type, xvm_tlm_fifo #(REQ), xvm_tlm_fifo #(RSP))
                             blocking_slave_export, 
                             nonblocking_slave_export;
  // internal fifos
  protected xvm_tlm_fifo #(REQ) m_request_fifo;
  protected xvm_tlm_fifo #(RSP) m_response_fifo;
...
//------------------------------------------------------------------------------
//
// CLASS  -- xvm_tlm_transport_channel #(REQ,RSP)
//
// A xvm_tlm_transport_channel is a <xvm_tlm_req_rsp_channel #(REQ,RSP)> that implements
...
class xvm_tlm_transport_channel #(type REQ=int, type RSP=REQ) 
                                     extends xvm_tlm_req_rsp_channel #(REQ, RSP);

  `uvm_component_param_utils(xvm_tlm_transport_channel#(REQ,RSP))
  `uvm_type_name_decl("xvm_tlm_transport_channel #(REQ,RSP)")
  
  typedef xvm_tlm_transport_channel #(REQ, RSP) this_type;
  ...
  xvm_transport_imp #(REQ, RSP, this_type) transport_export;
